...
export const PRESIDENTE: CargoEletivo = {
  ...
  fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Lula_-_foto_oficial05012023_%28cropped%29.jpg',
  partido: 'PT',
  mandato: '2023-2026',
  ordem: 1,
};
...
export const VICE_PRESIDENTE: CargoEletivo = {
  ...
  fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c2/Geraldo_Alckmin_em_2023_%28cropped%29.jpg',
  partido: 'PSB',
  mandato: '2023-2026',
  ordem: 2,
};
...
const GOVERNADORES: Record<string, { nome: string; partido: string; fotoUrl?: string }> = {
  AC: { nome: 'Gladson Cameli',         partido: 'PP',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/10/Gladson_Cameli_2019.jpg' },
  AL: { nome: 'Paulo Dantas',           partido: 'MDB',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/PauloDantas.jpg' },
  ...
  AM: { nome: 'Wilson Lima',            partido: 'União Brasil',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Wilson_Lima_-_2019_%28cropped%29.jpg' },
  BA: { nome: 'Jerônimo Rodrigues',     partido: 'PT',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/4f/Jer%C3%B4nimo_Rodrigues.jpg' },
  CE: { nome: 'Elmano de Freitas',      partido: 'PT',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/3f/Plen%C3%A1rio_do_Congresso_%2854441463325%29.jpg' },
  DF: { nome: 'Ibaneis Rocha',          partido: 'MDB',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/e/e9/Ibaneis_Rocha_foto_oficial.jpg' },
  ES: { nome: 'Renato Casagrande',      partido: 'PSB',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/cc/Renato_Casagrande_2019.jpg' },
  GO: { nome: 'Ronaldo Caiado',         partido: 'União Brasil',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/09/Ronaldo_Caiado.jpg' },
  ...
  MG: { nome: 'Romeu Zema',            partido: 'Novo',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/9/97/Romeu_Zema_Governador_de_Minas_Gerais.jpg' },
  PA: { nome: 'Helder Barbalho',        partido: 'MDB',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d0/Helder_Barbalho_-_2019_%28cropped%29.jpg' },
  ...
  PR: { nome: 'Carlos Massa Ratinho Junior', partido: 'PSD',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/Ratinho_Junior.jpg' },
  ...
  RJ: { nome: 'Cláudio Castro',         partido: 'PL',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/3d/Cl%C3%A1udio_Castro_Governador_do_Rio_de_Janeiro.jpg' },
  RN: { nome: 'Fátima Bezerra',         partido: 'PT',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/79/F%C3%A1tima_Bezerra_governadora_RN_%28cropped%29.jpg' },
  RS: { nome: 'Eduardo Leite',          partido: 'PSDB',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Eduardo_Leite_foto_oficial_2019_%28cropped%29.jpg' },
  ...
  SP: { nome: 'Tarcísio de Freitas',    partido: 'Republicanos',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/b4/Tarccisio_de_Freitas_%28cropped%29.jpg' },
