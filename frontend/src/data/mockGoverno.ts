...
const GOVERNADORES: Record<string, { nome: string; partido: string; fotoUrl?: string }> = {
  ...
  CE: { nome: 'Elmano de Freitas',      partido: 'PT',
        fotoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Plen%C3%A1rio_do_Congresso_%2854441463325%29.jpg/400px-Plen%C3%A1rio_do_Congresso_%2854441463325%29.jpg' },
